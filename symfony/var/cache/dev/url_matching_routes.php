...
return [
    ...
    [ // $staticRoutes
        ...
        '/addSubject' => [[['_route' => 'addSubject', '_controller' => 'App\\Controller\\CourseController::addSubject'], null, null, null, false, false, null]],
        '/course_manually' => [[['_route' => 'courseManually', '_controller' => 'App\\Controller\\CourseController::courseManually'], null, null, null, false, false, null]],
        '/subject_manually' => [[['_route' => 'subjectManually', '_controller' => 'App\\Controller\\CourseController::subjectManually'], null, null, null, false, false, null]],
        '/assign_manually' => [[['_route' => 'asssignManually', '_controller' => 'App\\Controller\\CourseController::asssignManually'], null, null, null, false, false, null]],
        '/listCourseUser' => [[['_route' => 'listCourseUser', '_controller' => 'App\\Controller\\CourseController::listCourseUser'], null, null, null, false, false, null]],
        '/listCourseUserManually' => [[['_route' => 'listCourseUserManually', '_controller' => 'App\\Controller\\CourseController::listCourseUserManually'], null, null, null, false, false, null]],
        '/assignSubject' => [[['_route' => 'assignSubject', '_controller' => 'App\\Controller\\CourseController::assignSubject'], null, null, null, false, false, null]],
        '/listCourseAs' => [[['_route' => 'listCourseAssign', '_controller' => 'App\\Controller\\CourseController::listCourseAssign'], null, null, null, false, false, null]],
